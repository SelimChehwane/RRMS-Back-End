...
// Update a recipe
$response = $recipeModel->updateRecipe($data->id, $data->name, $data->cuisine_type, $data->description, $data->instructions);
// What: Calls the updateRecipe method on the Recipe model instance, passing the necessary data.
// Why: Updates a recipe in the database using the data received in the POST request.
